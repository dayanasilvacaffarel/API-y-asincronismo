...
function consultaApi(endpoint) {
    ...
    fetch(endpoint)
        ...
        .then(datosJs => {
            ...
            const botonVerComentarios = document.querySelector("button");
            botonVerComentarios.remove();
        })
        .catch(function(){
...
const endpoint = 'https://jsonplaceholder.typicode.com/comments/?postId=1&postId=2';
